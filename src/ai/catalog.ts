...
const MAGISTERES: Programa[] = [
  ...
  { nombre: 'Magíster en Derecho del Trabajo, Procedimientos y Litigación Laboral', tipo: 'magister', facultad: 'Derecho', modalidad: 'online', duracion: '4 semestres', url: `${M}magister-en-derecho-del-trabajo-procedimiento-y-litigacion-laboral/` },
  { nombre: 'Magíster en Administración de la Construcción', tipo: 'magister', facultad: 'Arquitectura, Construcción y Medio Ambiente', modalidad: 'online', duracion: '4 semestres', url: `${M}magister-en-administracion-en-la-construccion/` },
  ...
  { nombre: 'Magíster en Gerontología para el Envejecimiento Activo', tipo: 'magister', facultad: 'Ciencias de la Salud', modalidad: 'online', duracion: '4 semestres', url: `${M}magister-en-gerontologia-para-un-envejecimiento-activo/` },
